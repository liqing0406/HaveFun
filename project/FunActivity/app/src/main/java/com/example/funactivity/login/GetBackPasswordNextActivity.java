...
public class GetBackPasswordNextActivity extends AppCompatActivity {
    ...
    private void login() {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if ("".equals(back)) {
                    Looper.prepare();
                    Toast.makeText(GetBackPasswordNextActivity.this, "账号或密码错误，请重新输入", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
                    userJson = back;
